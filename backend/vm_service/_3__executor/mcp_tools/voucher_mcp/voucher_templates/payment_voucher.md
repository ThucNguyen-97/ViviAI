    ...
    <tr>
        ...
        <td width="50%">
            <div class="sample-code-box">
                <span class="bold">Mẫu số: 02 - TT</span><br>
...
<!-- Phần 2: Logo (Trái) & Tiêu đề PHIẾU CHI (Giữa) -->
<table class="main-title-table">
    <tr>
        ...
        <td width="60%" class="text-center" style="vertical-align: top; padding-top: 15px">
            <div class="form-title">PHIẾU CHI</div>
            <span class="italic">Ngày {{payment_day}} tháng {{payment_month}} năm {{payment_year}}</span>
        </td>
        <td width="20%"></td>
    </tr>
...
<div class="info-section">
    Họ và tên người nhận tiền: {{payee_name}}<br>
    Đơn vị: {{payee_unit}}<br>
    Địa chỉ: {{payee_address}}<br>
    Lý do chi: {{payment_reason}}<br>
...
<div>
    ...
    <table class="signature-table">
        <tr class="bold">
            ...
            <td width="25%">Người nhận tiền</td>
